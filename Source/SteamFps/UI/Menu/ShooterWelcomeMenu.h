...
public:
	/** build menu */
	void Construct( TWeakObjectPtr< class USteamFpsGameInstance > InGameInstance );
	...
	TWeakObjectPtr< class USteamFpsGameInstance > GetGameInstance() { return GameInstance; }

private:
	/** Owning game instance */
	TWeakObjectPtr< class USteamFpsGameInstance > GameInstance;
