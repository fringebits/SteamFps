...
void FShooterWelcomeMenu::Construct( TWeakObjectPtr< USteamFpsGameInstance > InGameInstance )
{
...
void FShooterWelcomeMenu::HandleLoginUIClosed(TSharedPtr<const FUniqueNetId> UniqueId, const int ControllerIndex)
{
	...
	auto ShooterViewport = Cast<USteamFpsGameViewportClient>( GameInstance->GetGameViewportClient() );
