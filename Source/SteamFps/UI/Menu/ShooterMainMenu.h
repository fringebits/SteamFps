...
public:	
	...
	/** build menu */
	void Construct(TWeakObjectPtr<USteamFpsGameInstance> _GameInstance, TWeakObjectPtr<ULocalPlayer> _PlayerOwner);
...
protected:
	...
	TWeakObjectPtr<USteamFpsGameInstance> GameInstance;
