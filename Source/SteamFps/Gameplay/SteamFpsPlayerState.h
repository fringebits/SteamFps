...
public:
    ...
    */
    ...
    void ScoreKill(ASteamFpsPlayerState* Victim, int32 Points);

    /** player died */
    void ScoreDeath(ASteamFpsPlayerState* KilledBy, int32 Points);
    ...
    UFUNCTION(Reliable, Client)
        void InformAboutKill(class ASteamFpsPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class ASteamFpsPlayerState* KilledPlayerState);

    /** broadcast death to local clients */
    UFUNCTION(Reliable, NetMulticast)
        void BroadcastDeath(class ASteamFpsPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class ASteamFpsPlayerState* KilledPlayerState);
