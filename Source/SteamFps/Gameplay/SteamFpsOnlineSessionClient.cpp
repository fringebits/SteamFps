...
#include "SteamFps.h"
#include "SteamFpsOnlineSessionClient.h"
...
)
{
	...
	auto sgi = Cast<USteamFpsGameInstance>(GetGameInstance());
	...
	if (IsValid(sgi))
	{
        ...
        sgi->SetPendingInvite(PendingInvite);
        sgi->GotoState(ShooterGameInstanceState::PendingInvite);
	}
}
